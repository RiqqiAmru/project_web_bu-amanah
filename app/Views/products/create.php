              ...
              <div class="row">
                <div class="form-group col-sm-6">
                  ...
                  <select name="category_id" id=""
                    ...
                    <option <?= old('category_id') == $e['category_id'] ? 'selected' : '' ?>
                      value="<?= $e['category_id']; ?>"><?= $e['category_name']; ?></option>
                    <?php endforeach ?>
                  </select>
              ...
              <div class="row">
                <div class="form-group col-sm-6">
                  ...
                  <input type="number"
                    ...
                    name="product_price" placeholder="Rp. " value="<?= old('product_price'); ?>">
                ...
                <div class="form-group col-sm-6">
                  ...
                  <input type="text"
                    ...
                    name="product_sku" placeholder="Enter Product SKU" value="<?= old('product_sku'); ?>">
                  <div class="invalid-feedback">
                ...
                <div class="col-sm-6">
                  <div class="form-group ">
                    ...
                    <select name="product_status" id=""
                      ...
                      <option <?= old('product_status') == 'Inactive' ? 'selected' : '' ?> value="Inactive">Inactive
                      </option>
                    </select>
                    <div class="invalid-feedback">
